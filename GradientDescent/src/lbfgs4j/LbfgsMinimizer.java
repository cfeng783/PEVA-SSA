...
import liblbfgs.LbfgsConstant;
import liblbfgs.LbfgsConstant.LBFGS_Param;
import liblbfgs.LbfgsConstant.LBFGS_Evaluate;
import liblbfgs.LbfgsConstant.LBFGS_Progress;
import liblbfgs.MutableDouble;

import static liblbfgs.LbfgsConstant.ReturnValue.LBFGS_SUCCESS;
...
public class LbfgsMinimizer {
  ...
  public double[] minimize(Function f) {
    ...
    if(Lbfgs.lbfgs(dim, x, fx, eval, progress, null, param) ==  LBFGS_SUCCESS) {
    	return x;
    }else {
